                        ...
                        <div className={`col-xs-12 col-sm-6 col-md-4 ${expandedCard === index ? 'card-expanded' : 'card'}`} key={index}>
                            <div className="card">
                                <div className="view overlay">
                                    <img className="card-img-top" src={item.imagen} alt="Card image cap"/> {/* Aquí utilizamos item.imagen como la URL de la imagen */}
                                    <a href="#!">
                                ...
                                <div className="card-body">
                                    ...
                                    <button type="button" className="btn btn-light-blue btn-md" onClick={() => handleReadMore(index)}>Read more</button>
                                </div>
                            </div>
                        </div>
                    );
